...
public class IngredientMapperTest {
    ...
    public void it_should_map_entity_to_dto() {
        //given
        RecipeEntity recipe = new RecipeEntity(1, "Pita bread", "Desc example", "Instruc example", "google.com");
    ...
    public void it_should_return_null_recipe_entities_if_recipe_dtos_is_null() {
        //when
        List<IngredientEntity> ingredientEntities = mapper.mapToEntities(null);
        //then
    ...
    public void it_should_return_null_recipe_dtos_if_recipe_entities_is_null() {
        //when
        List<IngredientDto> ingredientDtos = mapper.mapToDtos(null);
        //then
